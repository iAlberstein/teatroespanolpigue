...
async function runMigration() {
  ...
  try {
    ...
    // Read SQL file
    const sqlFile = join(__dirname, '../../migrations/012_add_password_reset_fields.sql');
    ...
    console.log('  - ✓ Columna reset_token agregada a users');
    console.log('  - ✓ Columna reset_token_expiry agregada a users');
    console.log('  - ✓ Índice en reset_token creado');
